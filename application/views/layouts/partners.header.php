        ...
        <div class="container" style="vertical-align:middle">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav ms-auto mb-2 mb-md-0">
                    <li class="nav-item">
                        <a class="nav-link ms-2 me-2 <?= $uri_1 == 'dashboard' ? 'active' : '' ?>" href="<?= base_url() ?>partners/dashboard">
                            Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ms-2 me-2 <?= $uri_1 == 'help-center' ? 'active' : '' ?>" href="<?= base_url() ?>help-center">
                            Profile
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item ms-2">
                        <a href="<?= base_url() ?>partners/login" class="btn btn-outline-danger me-2">
                            Logout
                        </a>
                    </li>
                </ul>
